...
# data12_DEG.txtの2列目(Gene symbol)を抽出、ソートしてsorted_public_data12.txtとして保存する．
cat data12_DEG.txt | awk -F"\t" 'NR>2{print $2}' | sed 's/"//g' | awk -F"///" '{print $1}' | sort | uniq > sorted_public_data12.txt
...
## 799    1598   12723 data12_KEGG_ID_all.txt
...
## 720    1440   11639 data12_KEGG_ID.txt
...
## 79      83     791 data12_NO_KEGG_ID.txt
